"""
PERCOBAAN 18 – Robot Mecanum Teleop
====================================
Tujuan:
  - Menampilkan robot roda mecanum di Gazebo
  - Mengontrol gerak omnidirectional menggunakan teleop_twist_keyboard
...
def generate_launch_description():
    ...
    rviz_file  = os.path.join(pkg_share, 'rviz',   'percobaan18_mecanum.rviz')
