...
============================================
Tujuan:
  - Navigasi otonom menggunakan robot omnidirectional
  - Memanfaatkan kemampuan gerak lateral omnidirectional

Prasyarat: Jalankan percobaan16 dulu untuk membuat peta.
